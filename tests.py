...
def get_text():
    data = Database_Manager('pages/details.db').get_main_db_from_venue()
...
def configure_retriever():
    # Read documents
    docs = get_text()
    # make it as dict for the retriever
    # Split documents
    ...
    vectordb = DocArrayInMemorySearch.from_texts(texts=splits, embedding=embeddings)
